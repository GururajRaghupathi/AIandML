...
class ChatBot(object):
    ...
    def get_response(self, input_item):
        ...
        print("inputss",input_statement.text)

        temp_var= input_statement.text
        ...
        if sentence_classification=="decision":
            ...
            response= "Sorry.I can't perform this operation now."
            confidence=1
        else:
    	   ...
    	   #assign confidence for your purpose
            if(confidence < 0.6):
    	        response.text = "Sorry i couldn't get what you told.Please train me."
            else:
    	        response =response
